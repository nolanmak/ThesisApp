...
const AdminAnalysisPanel: React.FC<AdminAnalysisPanelProps> = ({
  selectedMessage,
  isMobile,
  showAnalysisPanel,
        ...
        <div className="h-full flex flex-col">
          ...
          <div className="pb-4 border-b border-neutral-200 dark:border-neutral-700 mb-4">
              ...
              >
                ...
                >
                  <div className="flex items-center">
                    ...
                    <span className="text-neutral-600 dark:text-neutral-300">Q{selectedMessage.quarter} {selectedMessage.year}</span>
                  </div>
            ...
            <div className="mt-2">
              ...
              {!selectedMessage.link && !selectedMessage.source && (
                <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-sky-100 text-sky-800 dark:bg-sky-900/50 dark:text-sky-200">
                  Earnings Analysis
                </span>
              )}
            </div>
