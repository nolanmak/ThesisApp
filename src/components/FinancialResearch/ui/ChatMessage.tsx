          ...
          {!message.isUser && message.metadata && (
            <div className="flex flex-wrap gap-2">
              {message.metadata.sources_count && (
                <span className="bg-blue-100 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 px-2 py-1 rounded-full text-xs">
                  {message.metadata.sources_count} sources
                </span>
              )}
              {message.metadata.query_type && (
                <span className="bg-green-100 dark:bg-green-900/20 text-green-600 dark:text-green-400 px-2 py-1 rounded-full text-xs">
                  {message.metadata.query_type}
                </span>
              )}
              {message.metadata.context_used && (
                <span className="bg-purple-100 dark:bg-purple-900/20 text-purple-600 dark:text-purple-400 px-2 py-1 rounded-full text-xs">
                  Context used
                </span>
              )}
            </div>
