      ...
      {selectedMessage || currentTicker ? (
        <div className="h-full flex flex-col">
          ...
          <div className="mb-3 border-b border-neutral-200 dark:border-neutral-700">
            ...
            {/* Tabs row - aligned with watchlist filter */}
                    ...
                    {currentTab?.hasData ? (
                      <div className="space-y-4">
                        ...
                        <SimpleBarChart
                          ...
                          labels={['Q8', 'Q7', 'Q6', 'Q5', 'Q4', 'Q3', 'Q2', 'Q1', 'Q0']}
                        ...
                        <SimpleBarChart
                          ...
                          title="Quarterly EPS"
                          color={[
                            '#10b981', // AV - Historical (green)
                            '#10b981', // AW - Historical (green)
